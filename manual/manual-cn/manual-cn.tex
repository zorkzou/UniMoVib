...
\vspace{1cm} \zihao{3}（1.4.2版）\vspace{20 mm} \\
...
\bigskip{}\noindent
\verb|IFMOLDEN|：（\verb|.True.|/\verb|.False.|）除了\verb|QCProg="AtomCalc"|之外，保存\textsc{Molden}文件，它可以用\href{https://www3.cmbi.umcn.nl/molden/}{\textsc{Molden}} 或\href{http://gabedit.sourceforge.net/}{\textsc{Gabedit}}程序打开，用于显示分子结构和振动模式。默认：\verb|.False.|
